import rnd from "bcrypto/lib/random.js";
import sha256 from "bcrypto/lib/sha256.js";
import elliptic from "bcrypto/lib/js/elliptic.js";
...
function tdh2Encrypt(pub: any, msg: any, label: any) {
...
function concatenate(points: any) {
  var out = groupName;
...
function hash1(point: any) {
  return sha256.digest(
    Buffer.concat([Buffer.from("tdh2hash1"), concatenate([point])])
  );
}

function hash2(msg: any, label: any, p1: any, p2: any, p3: any, p4: any) {
...
export function encrypt(pub: any, msg: any) {
